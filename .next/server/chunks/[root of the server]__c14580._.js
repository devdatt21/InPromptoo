...
"[project]/app/api/prompt/new/route.js [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const POST = async (req, res)=>{
    const { prompt, creator, tag } = await req.json();
    try {
        ...
        const newPrompt = new __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$prompt$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"]({
            prompt,
            creator,
            tag
        });
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__c14580._.js.map